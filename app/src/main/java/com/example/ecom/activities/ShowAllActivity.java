...
import com.example.ecom.adapter.ShowAllAdapter;
...
public class ShowAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (type != null && type.equalsIgnoreCase("hair")){
            System.out.println("type is makeup------------------------------------");
            firestore.collection("ShowAll").whereEqualTo("type","hair")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if (type != null && type.equalsIgnoreCase("face")){
            firestore.collection("ShowAll").whereEqualTo("type","face")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
